...
*/$exec = mysql_query("SELECT ip_count,dns_root FROM dump_info WHERE time >DATE_SUB(CURRENT_TIMESTAMP(), INTERVAL 1 minute) ORDER BY ip_count DESC LIMIT 6;");
 ...
 ?>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Domain', 'Total Packets'],
        <?php 
$exec = mysql_query("SELECT ip_count,dns_root FROM dump_info ORDER BY ip_count DESC LIMIT 6;"); 
